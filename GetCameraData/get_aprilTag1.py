...
# 创建一个apriltag检测器，然后检测AprilTags
    ...
    # # 绘制检测到的AprilTag的框
        cv2.line(img, a, b, (255, 0, 255), 1, lineType=cv2.LINE_AA)
        cv2.line(img, b, c, (255, 0, 255), 1, lineType=cv2.LINE_AA)
        cv2.line(img, c, d, (255, 0, 255), 1, lineType=cv2.LINE_AA)
        cv2.line(img, d, a, (255, 0, 255), 1, lineType=cv2.LINE_AA)
    ...
    # 在图像上绘制标文本
        ...
        cv2.putText(img, tagFamily, (a[0], a[1] - 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
